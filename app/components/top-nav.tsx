            ...
            {showGuestActions ? (
              <>
                <SignInButton mode="modal">
                  <button
                    type="button"
                    className="btn-secondary h-9 cursor-pointer px-3 py-1.5 text-sm"
                  >
                    Sign in
                  </button>
                </SignInButton>
                <SignUpButton mode="modal">
                  <button type="button" className="btn-primary h-9 cursor-pointer px-4 text-sm">
                    Sign up
                  </button>
                </SignUpButton>
              </>
